...
export async function generateMetadata({
  ...
  const description = getPostTypeDescription(locale, type, posts.length);
...
export default async function TypeCollectionPage({
  params,
}: {
  params: Promise<{ locale: string; type: string }>;
}) {
  ...
  const basePath = buildPostTypePath(locale, type);
